...
export const projects = [
  ...
  {
    title: "Trainning App",
    description: "Aplicación integral para la gestión de entrenamientos, permitiendo a profesores crear rutinas personalizadas ajustando ejercicios, repeticiones y descansos.",
    technologies: ["Next.js 14", "NestJS", "Prisma", "PostgreSQL", "Redux Toolkit"],
    highlights: [
      "Gestión de rutinas personalizadas",
      "Arquitectura monorepo robusta",
